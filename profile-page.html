...
-->
    ...
    <!-- Site title
   ================================================== -->
    <title>KanKook - Profile Page</title>
...
================================================== -->
    <section id="profile-page">
        <div class="wow fadeInUp container1" data-wow-delay="2s">

            <div class="profile">

                <div class="profile-image">

                    <img src="https://images.unsplash.com/photo-1513721032312-6a18a42c8763?w=152&h=152&fit=crop&crop=faces" alt="" style="width: 60%; height: 60%;">
                ...
                <div class="profile-bio">
                    ...
                    <p>
                        <span class="profile-real-name">Jane Doe</span> Lorem ipsum dolor sit, amet consectetur adipisicing elit</p>
    ...
    <section id="single-project">
        <div class="container">
            <div class="row">
                ...
                <div class="wow fadeInUp col-md-12" data-wow-delay="2.3s">
                    <h1 class="direction"> My Collection </h1>
                    <div class="wow fadeInUp" data-wow-delay="2.6s">
                        <div class="iso-box-wrapper">

                            <div class="iso-box  col-md-3 col-sm-6">
                                <div class="portfolio-thumb">
                                    <div class="card">
                                        <img src="images/portfolio-img1.jpg" alt="Avatar" style="width:100%">
                                    </div>
