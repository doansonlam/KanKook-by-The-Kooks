      ...
      <div class="navbar">
         <div class="container">
            <div class="row">
              ...
              <div class="brand">
                <a href="index.html"><img src="images/cce_2@72x-8.png" height="50%" /></a>
              </div>
	...
	<div class="container" >
		<div class="row">
          ...
          <div class="header-thumb">
              <h1 class="wow fadeIn" data-wow-delay="1.6s">Search for food now !</h1>
              <h3 class="wow fadeInUp" data-wow-delay="1.9s"> <input type="text" class="form-control" placeholder="Search"></h3>
          </div>
			</div>
